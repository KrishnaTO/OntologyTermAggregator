...
<<<<<<< HEAD:vignettes/Ontology-term-example.Rmd

if(searchTerm == "Neurofibroma" & file.exists("../data/Searchtoclasses_json.RData")){
=======
if(file.exists("../data/Searchtoclasses_json.RData")){
>>>>>>> faf12afa028a4786824945a780dc6895ed6a35e3:vignettes/SearchviaCombinedOntology.Rmd
